select B.Date AS Date, (A.a3t1-B.a3t1) AS a3t1,(A.a3t2-B.a3t2) AS a3t2,(A.a4t1-B.a4t1) AS a4t1,(A.a8t1-B.a8t1) AS a8t1,(A.a16t1-B.a16t1) AS a16t1
from 
(SELECT ROW_NUMBER() OVER (ORDER BY convert(varchar(100),time, 111)) AS id ,  [a3t1]
  ...
  where B.id = A.id-1 order by B.Date and A.Date between  @startDate and @endDate;