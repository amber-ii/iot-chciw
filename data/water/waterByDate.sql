select Date,Press,I1sp,I2sp,cast(round(SaveAmount,3) as numeric(20,3)) as 'SaveAmount' from 
(select convert(varchar(16), time, 120) as Date,
...
(CASE WHEN [I1sp] > 0 THEN (1-POWER([I1sp]/60,3))*15*746/1000
      ...
      ELSE 0
      END) as 'SaveAmount'
from [KEP].[dbo].[CH1WaterProjDB] where (convert(varchar,time, 126)) LIKE  '%:00:%' )as A
