...
select (A.sacidDate)AS "日期" , (A.A9F1-B.A9F1)AS "A9每日產能-進6/7號坦克" ,(A.A10F1-B.A10F1)AS "A10每日產能-進6/7號坦克",(A.A10F4-B.A10F4)AS "A9A10每日產能-進5/9號坦克",   (A.A9F1-B.A9F1)+(A.A10F1-B.A10F1)+(A.A10F4-B.A10F4) AS "A9+A10總量(進5679號坦克加總)"  ,(A.A10F2-B.A10F2)AS "配酸出口流量計",(A.A10F3-B.A10F3)AS "配酸回流流量計",(A.A10F3-B.A10F3)-(A.A10F2-B.A10F2) AS "配酸使用量(配酸回流-配酸出口)"
from 
(SELECT  ROW_NUMBER() OVER (ORDER BY convert(varchar(100),time, 111)) AS id ,([A9F1p] - [A9F1n])as A9F1,([A10F1p] - [A10F1n])as A10F1,([A10F2p] - [A10F2n])as A10F2,([A10F3p] - [A10F3n])as A10F3,([A10F4p] - [A10F4n])as A10F4
      , (convert(varchar(100),time, 111)) as sacidDate
  FROM [KEP].[dbo].[CH1ACIFLOW]  where (convert(varchar(100),time, 126)) LIKE  '%07:00:%')AS A , 
